...
def create_example_items():
    ...
    items.append(Weapon(
        name="Pupblade",
        description="A lightweight blade sized perfectly for a corgi’s reach. Fast and nimble.",
        image_path="../../graphics/items/pupblade.png",
        attack_bonus=5,
        value=100
    ))
    ...
    items.append(Weapon(
        name="Barkwood Bow",
        description="Crafted from enchanted barkwood; arrows whistle like tiny barks.",
        image_path="../../graphics/items/barkwood_bow.png",
        attack_bonus=5,
        value=100
    ))
    ...
    items.append(Armor(
        name="Padded Vest",
        description="Soft, flexible armor that keeps the user comfy and protected.",
        image_path="../../graphics/items/padded_vest.png",
        defense_bonus=3,
        value=80
    ))

    items.append(Armor(
        name="Chainmail Harness",
        description="A jingling harness of interlinked rings.",
        image_path="../../graphics/items/chainmail_harness.png",
        defense_bonus=5,
        value=200
    ))
    ...
    items.append(Consumable(
        name="Bone Broth",
        description="Restores 40 HP. Warm, savory broth that revitalizes tired paws.",
        image_path="../../graphics/items/bone_broth.png",
        effect_type="heal",
        effect_amount=40,
        value=10,
        max_stack=64
    ...
    items.append(Consumable(
        name="Salmon Steak",
        description="Restores 100 HP. A hearty, protein‑packed meal for serious adventuring.",
        image_path="../../graphics/items/salmon_steak.png",
        effect_type="heal",
        effect_amount=100,
        value=50,
        max_stack=64
    ...
    items.append(Consumable(
        name="Puppuccino",
        description="Increases speed temporarily. A frothy delight that fills with boundless enthusiasm.",
        image_path="../../graphics/items/puppuccino.png",
        effect_type="speed",
        effect_amount=5,
        value=30,
        max_stack=16
    ...
    items.append(Item(
        name="Silver Key",
        item_type="tool",
        description="A shiny silver key that unlocks a secret.",
        image_path="../../graphics/items/silver_key.png",
    ))
