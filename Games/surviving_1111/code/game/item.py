...
def create_example_items():
    ...
    items.append(Item(
        name="Private Key",
        item_type="tool",
        description="Grants you acsess to ece-000",
        image_path="../../graphics/items/private_key.png",
    ))
    
    # Weapons
    items.append(Weapon(
        name="Keyboard",
        description="Basic Weapon. Good for typing and slashing!",
        image_path="../../graphics/items/keyboard.png",
        attack_bonus=5,
        value=200
    ))
    ...
    items.append(Weapon(
        name="Mouse",
        description="Simple Long Range Weapon. Picones not a fan",
        image_path="../../graphics/items/mouse.png",
        attack_bonus=2,
        value=300
    ))
    ...
    items.append(Weapon(
        name="Pointer_lance",
        description="A slow attacking weapon, has a chance to ignore enemy armor",
        image_path="../../graphics/items/pointer_lance.png",
        attack_bonus=10,
        value=1000
    ))

    items.append(Weapon(
        name="Compiler Hammer",
        description="A slow attacking weapon. High in damage.",
        image_path="../../graphics/items/compiler_hammer.png",
        attack_bonus=20,
        value=1500
    ))
    ...
    items.append(Consumable(
        name="Energy Drink",
        description="Gives you some extra energy",
        image_path="../../graphics/items/energy_drink.png",
        effect_type="Speed",
        effect_amount=5,
        value=15,
        max_stack=10
    ...
    items.append(Consumable(
        name="Grade Report",
        description="Grants you additional xp based on your grade",
        image_path="../../graphics/items/grade_report.png",
    ...
    items.append(Armor(
        ...
        image_path="../../graphics/items/hoodie.png",
        defense_bonus=2,
        value=80
    ))
